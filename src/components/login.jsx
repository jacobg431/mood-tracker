...
export default function Login(props) {
    ...
    const formStyle =
        'max-w-5xl rounded-3xl border border-white/60 bg-green-100/70 shadow-[0_20px_80px_-30px_rgba(0,0,0,0.25)] backdrop-blur-xl';
    ...
    const inputWrapperStyle =
        'mt-3 rounded-2xl border border-cyan-100 bg-white/70 px-4 py-4 shadow-sm text-xl sm:text-2xl';
    const inputFieldStyle = 'flex items-center justify-center rounded-md outline-none text-gray-800';
    const buttonStyle =
        'cursor-pointer rounded-2xl px-5 py-4 text-xl sm:text-2xl font-semibold ' +
